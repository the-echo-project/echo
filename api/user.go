...
func createUser(w http.ResponseWriter, r *http.Request) {
	...
	if err := db.EchoDB.QueryRowx("INSERT INTO users (first_name, last_name, username, email, roles, password) values ($1, $2, $3, $4, $5, crypt($6, gen_salt('bf'))) RETURNING user_id", u.FirstName, u.LastName, u.Username, u.Email, nil, u.Password).StructScan(&u); err != nil {
		w.WriteHeader(http.StatusInternalServerError)
		log.This.Warning(err.Error())
		return
	}
